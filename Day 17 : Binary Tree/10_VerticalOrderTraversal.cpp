...
public:
    vector<vector<int>> verticalTraversal(TreeNode* root) {
        ...
        // Initialise a ‘multiset’ to store node values
        // at a specific vertical and level to ensure unique and sorted order of nodes.
        map<int, map<int, multiset<int>>> nodes; // (x,(y,node->val))
